...
export default function AboutIntro() {
  return (
    <div className='mx-auto relative   p-4 m-2 lg:p-12 2xl:p-24 lg:w-11/12 2xl:w-10/12  '>
      <img
        src='/images/about-img-2.jpg'
        alt='Picture of the author'
        className='w-[180px] h-[500px] lg:w-[500px]  lg:pt-12 2xl:pt-4 rounded shadow-lg float-left mr-8 aspect-[1/1] object-cover object-center lg:aspect-[1/2] lg:[clip-path:polygon(0%_0%,100%_0%,75%_100%,0%_100%)] lg:[shape-outside:polygon(0%_0%,100%_0%,75%_100%,0%_100%)] [clip-path:circle(70%_at_10%_30%)] [shape-outside:circle(70%_at_10%_30%)]'
      />
      <div className='p-6 lg:p-12 md:text-lg  xl:text-xl space-y-12  h-auto align-center'>
        <p>
